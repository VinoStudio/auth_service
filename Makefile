...
MIGRATIONS = ./docker_compose/migrations.yaml
...
.PHONY: app
app:
	$(DC) $(GROUP) -f $(APP_FILE) -f $(POSTGRES_FILE) -f $(POSTGRES_TEST_FILE) -f $(PGADMIN_FILE) -f $(MIGRATIONS) -f $(KAFKA_FILE) -f $(REDIS_FILE) -f $(CELERY_FILE) $(ENV) up --build -d

.PHONY: down
down:
	$(DC) $(GROUP) -f $(APP_FILE) -f $(POSTGRES_FILE) -f $(POSTGRES_TEST_FILE) -f $(PGADMIN_FILE) -f $(MIGRATIONS) -f $(KAFKA_FILE) -f $(REDIS_FILE) -f $(CELERY_FILE) $(ENV) down
